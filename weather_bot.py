...
async def get_weather(message: types.Message):
    try:
        ...
        sunrise_timestamp = datetime.datetime.fromtimestamp(data["sys"]["sunrise"]).astimezone()
        sunset_timestamp = datetime.datetime.fromtimestamp(data["sys"]["sunset"]).astimezone()
